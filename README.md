...
| [prove-your-tests-can-fail](./prompts/prove-your-tests-can-fail.md) | development-workflow | 1.0.0 | 2026-08-28 | 834 | Verify that tests can actually fail, catching assertions that pass no matter what the code does. |
| [test-suite-generator](./prompts/test-suite-generator.md) | development-workflow | 1.2.0 | 2026-08-28 | 1598 | Generate a comprehensive test suite with unit, integration and e2e coverage, plus skipped-test cleanup. |
...
| [autonomous-backlog-workflow](./prompts/autonomous-backlog-workflow.md) | project-management | 1.0.0 | 2026-08-28 | 1004 | Select, validate, implement, review and close a coherent batch of backlog tickets autonomously, with bounded quality loops. |
...
| [project-reassessment](./prompts/project-reassessment.md) | project-management | 1.1.3 | 2026-08-28 | 1555 | Full repository health check aligning code, documentation and policies. |
