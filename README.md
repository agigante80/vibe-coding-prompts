...
| [prove-your-tests-can-fail](./prompts/prove-your-tests-can-fail.md) | development-workflow | 1.0.0 | 2026-08-28 | 865 | Verify that tests can actually fail, catching assertions that pass no matter what the code does. |
...
| [autonomous-backlog-workflow](./prompts/autonomous-backlog-workflow.md) | project-management | 1.0.0 | 2026-08-28 | 1033 | Select, validate, implement, review and close a coherent batch of backlog tickets autonomously, with bounded quality loops. |
